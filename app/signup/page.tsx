        ...
        <div className="w-full max-w-md animate-float-up">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-text-muted text-base leading-relaxed">
              Start turning blog posts into beautiful infographics.
            </p>
          </div>
          ...
          <div className="relative rounded-2xl border border-white/[0.06] bg-surface/80 backdrop-blur-xl p-8 shadow-2xl shadow-purple-950/20">
            ...
            <form onSubmit={handleSubmit} className="relative space-y-5">
              {/* Name */}
              <div>
                <label htmlFor="signup-name" className="block text-xs font-medium text-text-muted mb-1.5 uppercase tracking-wider">
                  Full name
                </label>
                <input
                  id="signup-name"
              ...
              {/* Email */}
              <div>
                <label htmlFor="signup-email" className="block text-xs font-medium text-text-muted mb-1.5 uppercase tracking-wider">
                  Email
                </label>
                <input
                  id="signup-email"
              ...
              {/* Password */}
              <div>
                <label htmlFor="signup-password" className="block text-xs font-medium text-text-muted mb-1.5 uppercase tracking-wider">
                  Password
                </label>
                <input
                  id="signup-password"
              ...
              {/* Confirm password */}
              <div>
                <label htmlFor="signup-confirm-password" className="block text-xs font-medium text-text-muted mb-1.5 uppercase tracking-wider">
                  Confirm password
                </label>
                <input
              ...
              {success && (
                <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.06] px-4 py-3">
                  <div className="flex items-center gap-2.5">
                    <svg className="text-emerald-400 flex-shrink-0" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
